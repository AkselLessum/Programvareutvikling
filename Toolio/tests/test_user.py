...
class RegisterTest(BaseTest):
    ...
    def test_register_page_is_visible(self):
        ...
        print("Asserting that user page is visible...")
    ...
    def test_register_new_user(self):
        ...
        print("Asserting that user is able to register...")
    ...
    def test_register_new_user_check_database(self):
        ...
        print("Asserting that user is succesfully created and exists in database...")
        self.assertTrue(user_exists, f"User was not created in the database.")


    def test_register_invalid_username(self):
        self.client.post(
            self.register_url, self.user_invalid_username, format='text/html')

        user_exists = CustomUser.objects.filter(
            username="?Navnesen?").exists()
        print("Asserting that user is unable to register with invalid characters in username...")
    ...
    def test_duplicate_username(self):
        ...
        print("Asserting that user is unable to register with a duplicate username...")
    ...
    def test_cant_register_user_with_unmatching_passwords(self):
        ...
        print("Asserting that user is unable to register with unmatching passwords...")
        self.assertEqual(response.status_code, 400)
    ...
    def test_cant_register_user_with_invalid_email(self):
        ...
        print("Asserting that user is unable to register with invalid email...")
        self.assertEqual(response.status_code, 400)
    ...
    def test_cant_register_user_with_invalid_number(self):
        ...
        print("Asserting that user is unable to register with invalid phone number...")
    ...
    def test_cant_register_user_with_non_existing_postal_code(self):
        ...
        print("Asserting that user is unable to register with invalid postal code...")
